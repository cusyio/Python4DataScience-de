...
Bibliotheken und Methoden
=========================

Für die `Datenbereinigung <https://de.wikipedia.org/wiki/Datenbereinigung>`_ und
-validierung mit Python verwenden wir neben bekannten Bibliotheken wie
...
:doc:`voluptuous <voluptuous>`, :doc:`tdda <tdda>` und :doc:`hypothesis
<hypothesis>`. Wir bevorzugen diese leichtgewichtigeren Lösungen gegenüber
großen, universellen Systemen wie `Great Expectations
